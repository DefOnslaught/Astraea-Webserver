...
const ProfileNotFoundError = ({username}) => {
    useDocumentTitle('Profile Not Found | Astraea');
    ...
    return (
        <div className="flex min-h-screen flex-col justify-center items-center px-6 lg:px-8 text-center">
            ...
            <p className="mt-6 text-lg font-medium text-gray-400 sm:text-xl/8">
                The requested requested username of '<strong>{username}</strong>' could not be found.
            </p>
