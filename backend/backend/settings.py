...
SECRET_KEY = '*p=##hx9!^o92(^g47w94glrm5#2wjzklkylirnbq_+us^nr$e83-2762n^tt3gq(alpad(a0dyveg)wy475d_*z+^1z))i*ikt6'
...
STATIC_URL = 'assets/'
STATICFILES_DIRS = [
    BASE_DIR / '..' / 'frontend' / 'dist' / 'assets', # Path to your JS/CSS assets
]
